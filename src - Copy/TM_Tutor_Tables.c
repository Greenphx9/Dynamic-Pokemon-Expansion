...
{
	MOVE_FIREPUNCH,			//1 //Done
	MOVE_ICEPUNCH,			//2 //Done
	MOVE_THUNDERPUNCH,		//3 //Done
	MOVE_SNORE,				//4
	MOVE_HEALBELL,			//5
	MOVE_ELECTROWEB,		//6
	MOVE_LOWKICK,			//7 //Done
	...
	MOVE_HEATWAVE,			//51
	MOVE_HYPERVOICE,		//52
	MOVE_SUPERPOWER,		//53 //Done
	MOVE_KNOCKOFF,			//54
	MOVE_PSYCHUP,			//55
	MOVE_VACUUMWAVE,		//56 //Done
	MOVE_LASTRESORT,		//57
	MOVE_CONFIDE,			//58
	MOVE_GRASSPLEDGE,		//59
	MOVE_FIREPLEDGE,		//60
	...
	MOVE_MISTYEXPLOSION,			//82
	MOVE_POLTERGEIST,			//83
	MOVE_SKITTERSMACK,			//84
	MOVE_PINMISSILE,		//85
	MOVE_ICICLESPEAR,		//86
	MOVE_TAILSLAP,			//87
	MOVE_ROCKBLAST,			//88
