...
enum MoveTutors
{
	...
	TUTOR147_MOONBLAST,
	TUTOR148_FLOATYFALL,
	TUTOR149_SPLISHYSPLASH,
	TUTOR150_ZIPPYZAP,
	TUTOR151_BADDYBAD,
	TUTOR152_BOUNCYBUBBLE,
	TUTOR153_BUZZYBUZZ,
	TUTOR154_FREEZYFROST,
	TUTOR155_GLITZYGLOW,
	TUTOR156_SAPPYSEED,
	TUTOR157_SIZZLYSLIDE,
	TUTOR158_SPARKLYSWIRL,

//Special Move Tutors - Not in Table
	TUTOR_SPECIAL_DRACO_METEOR,			//159 - Dragon Pokemon
	TUTOR_SPECIAL_SECRET_SWORD,			//160 - Keldeo only
	TUTOR_SPECIAL_RELIC_SONG,			//161 - Meloetta only
	TUTOR_SPECIAL_VOLT_TACKLE,			//162 - Pikachu only
	TUTOR_SPECIAL_DRAGON_ASCENT,		//163 - Rayquaza only
	TUTOR_SPECIAL_THOUSAND_ARROWS,		//164 - Zygarde only
	TUTOR_SPECIAL_THOUSAND_WAVES,		//165 - Zygarde only
	TUTOR_SPECIAL_CORE_ENFORCER,		//166 - Zygarde only
	TUTOR_SPECIAL_STEEL_BEAM,			//167 - Steel Pokemon
};

#define LAST_TOTAL_TUTOR_NUM 155
