...
enum
{
	...
	ITEM_RILLABOOMITE,		//0x24B
	ITEM_CINDERACITE,		//0x24C
	ITEM_INTELEITE,			//0x24D
	ITEM_CORVISITE,		//0x24E
	ITEM_ORBEETLITE,		//0x24F
	ITEM_DREDNAWITE,		//0x250
	ITEM_COALOSSITE,		//0x251
	ITEM_APPLITE,			//0x252
	ITEM_SANDACONDITE,		//0x253
	ITEM_TOXTRICITE,		//0x254
	ITEM_CENTISKITE,			//0x255
	ITEM_HATTERENITE,	//0x256
	ITEM_GRIMMSNALITE,		//0x257
	ITEM_ALCREMITE,			//0x258
	ITEM_COPPERANITE,		//0x259
	ITEM_DURALUDONITE,		//0x25A
...
#define ITEM_LEADERS_CREST 0x2E4
